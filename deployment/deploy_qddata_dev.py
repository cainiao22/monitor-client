...
def package():
	...
	os.chdir(branch)
	cmd = '/opt/software/apache-maven-3.2.3/bin/mvn clean package -P dev  -DSkipTests -Denv=dev -Djava.home=' + os.environ['JAVA_HOME'] + '/jre'
	execute_cmd(cmd)
...
if __name__ == '__main__':
	...
	branchName = 'dev'
	if len(sys.argv) <= 1:
		print("The default branch will not be acquired by the branch name : ", branchName)  
	else:
